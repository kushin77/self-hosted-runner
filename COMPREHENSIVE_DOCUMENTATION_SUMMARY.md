...
|----------|---------|----------|------|
| **OPERATIONS_RUNBOOK.md** | Daily operations & procedures | All ops staff | [View](OPERATIONS_RUNBOOK.md) |
| **OPERATIONS_TEAM_HANDBOOK.md** | Comprehensive team manual | Team leads + ops | [View](OPERATIONS_TEAM_HANDBOOK.md) |
| **CRITICAL_INCIDENT_RESPONSE_GUIDE.md** | Emergency procedures | On-call + incident response | [View](CRITICAL_INCIDENT_RESPONSE_GUIDE.md) |
| **QUICK_REFERENCE_CARD.md** | Emergency quick reference | All on-call staff | [View](QUICK_REFERENCE_CARD.md) |
