...
→ **Start here:** [GSM_AWS_CREDENTIALS_ARCHITECTURE.md](GSM_AWS_CREDENTIALS_ARCHITECTURE.md)  
...
→ **Start here:** [GSM_AWS_CREDENTIALS_VERIFICATION.md](GSM_AWS_CREDENTIALS_VERIFICATION.md)  
...
3. **Want understanding?** → [GSM_AWS_CREDENTIALS_ARCHITECTURE.md](GSM_AWS_CREDENTIALS_ARCHITECTURE.md)
4. **Want to verify?** → [GSM_AWS_CREDENTIALS_VERIFICATION.md](GSM_AWS_CREDENTIALS_VERIFICATION.md)
