...
Action taken: Pull request workflows and templates are deprecated. The repository will not use PRs while CI/CD is paused. All dependency automation and PR-creating automation has been disabled or archived.
...
- Updated `CONTRIBUTING.md` to deprecate PRs and replace PR instructions with draft-issue + direct-deploy flow
...
- Do not open PRs or rely on GitHub Actions for deployments while this directive is active.
