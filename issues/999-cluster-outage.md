...
Resolution
----------
Closed on 2026-03-06: Operator opted to proceed using the protected GitLab CI deploy and GCP Secret Manager (GSM) path to avoid local workstation topology restrictions. See `issues/101-deploy-via-ci.md` and `infra/gitlab-runner/README.md` for GSM CI instructions.
