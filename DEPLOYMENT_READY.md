...
See **[docs/FULL_STACK_DEPLOYMENT_CHECKLIST.md](docs/FULL_STACK_DEPLOYMENT_CHECKLIST.md)** for complete troubleshooting guide.
...
2. [ ] Follow [deployment checklist](docs/FULL_STACK_DEPLOYMENT_CHECKLIST.md)
