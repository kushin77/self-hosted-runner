...
- [GSM_VAULT_RUNBOOK.md](docs/security/GSM_VAULT_RUNBOOK.md) — integration guide
- [WORKLOAD_IDENTITY_RUNBOOK.md](docs/WORKLOAD_IDENTITY_RUNBOOK.md) — WIF setup & usage
