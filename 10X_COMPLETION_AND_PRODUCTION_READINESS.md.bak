...
### Available Runbooks
1. [PRODUCTION_DEPLOYMENT_CERTIFICATION.md](PRODUCTION_DEPLOYMENT_CERTIFICATION.md) - Deployment procedures
2. [PRODUCTION_HANDOFF_MANIFEST.md](PRODUCTION_HANDOFF_MANIFEST.md) - Configuration checklist
...
### Pre-Deployment
- [ ] Read [PRODUCTION_DEPLOYMENT_CERTIFICATION.md](PRODUCTION_DEPLOYMENT_CERTIFICATION.md)
...
1. Configure GCP OIDC credentials per [PRODUCTION_DEPLOYMENT_CERTIFICATION.md](PRODUCTION_DEPLOYMENT_CERTIFICATION.md)
...
### Documentation
- **Primary**: [PRODUCTION_DEPLOYMENT_CERTIFICATION.md](PRODUCTION_DEPLOYMENT_CERTIFICATION.md)
