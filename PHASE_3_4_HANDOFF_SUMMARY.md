...
2. **[ROADMAP.md](../ROADMAP.md)** — Phase 4 self-healing and Phase 5 vision (high-level)
...
4. **[docs/GSM_VAULT_INTEGRATION.md](../docs/GSM_VAULT_INTEGRATION.md)** 
...
5. **[docs/SECRETS_RUNBOOKS_AUDIT.md](../docs/SECRETS_RUNBOOKS_AUDIT.md)**
