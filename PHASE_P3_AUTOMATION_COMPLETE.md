...
- **Main Operations Guide**: [docs/PHASE_2_3_OPS_RUNBOOK.md](docs/PHASE_2_3_OPS_RUNBOOK.md)
- **Observability & Secrets**: [docs/OBSERVABILITY_SECRETS.md](docs/OBSERVABILITY_SECRETS.md)
- **Pre-Apply Automation**: [docs/PHASE_P3_PRE_APPLY_AUTOMATION.md](docs/PHASE_P3_PRE_APPLY_AUTOMATION.md)
- **Supply-Chain Security**: [docs/AIRGAP_DEPLOYMENT_AUTOMATION_GUIDE.md](docs/AIRGAP_DEPLOYMENT_AUTOMATION_GUIDE.md)
