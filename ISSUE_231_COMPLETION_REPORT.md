...
See [`AWS_OIDC_SETUP.md`](AWS_OIDC_SETUP.md) for complete setup guide:
...
**Next Action:** Operator to configure AWS OIDC and IAM role permissions per [AWS_OIDC_SETUP.md](AWS_OIDC_SETUP.md)
