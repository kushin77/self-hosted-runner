...
- **Operator Playbook**: [HANDS_OFF_OPERATOR_PLAYBOOK.md](./HANDS_OFF_OPERATOR_PLAYBOOK.md)
- **Secrets Setup**: [SECRETS_SETUP_GUIDE.md](./SECRETS_SETUP_GUIDE.md)
- **Deploy Key Runbook**: [DEPLOY_KEY_REMEDIATION_RUNBOOK.md](./DEPLOY_KEY_REMEDIATION_RUNBOOK.md)
- **CI/CD Governance**: [CI_CD_GOVERNANCE_GUIDE.md](./CI_CD_GOVERNANCE_GUIDE.md)
