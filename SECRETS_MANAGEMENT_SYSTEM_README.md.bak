...
**Location**: [CONTRIBUTING.md](CONTRIBUTING.md) (updated)
...
| [CONTRIBUTING.md](CONTRIBUTING.md) | Updated | +200 | Enhanced secrets section |
...
- [CONTRIBUTING.md](CONTRIBUTING.md) — Contributing rules + examples
...
- [docs/VAULT_GETTING_STARTED.md](docs/VAULT_GETTING_STARTED.md) — Vault integration
