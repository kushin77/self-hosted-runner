...
## 🎯 IMMUTABLE DEPLOYMENT PROVISIONING (NEW)

**Credentialing & Policy Framework** - Following user requirements: immutable, ephemeral, idempotent, no-ops, fully automated hands-off, GSM/VAULT/KMS for all creds, no branch direct development.

| Task | Issue | Status | Action |
|------|-------|--------|--------|
| **Vault Production Hardening** | [#2101](https://github.com/kushin77/self-hosted-runner/issues/2101) | ⏳ | Replace dev token with AppRole; harden systemd handling |
| **AWS Secrets Manager Provisioning** | [#2100](https://github.com/kushin77/self-hosted-runner/issues/2100) | ⏳ | Create secret + KMS key + IAM role for watcher |
| **GSM Permissions Grant** | [#2103](https://github.com/kushin77/self-hosted-runner/issues/2103) | ⏳ | Grant Secret Manager access to automation service account |
| **Disable CI/PR Workflows** | [#2102](https://github.com/kushin77/self-hosted-runner/issues/2102) | ⏳ | Archive prod workflows; enforce direct-deploy-only policy |
| **Policy Enforcement** | [#2104](https://github.com/kushin77/self-hosted-runner/issues/2104) | ⏳ | Immutable bundles + ephemeral credentials + audit trail |

**Complete Runbook:** See [CREDENTIAL_PROVISIONING_RUNBOOK.md](CREDENTIAL_PROVISIONING_RUNBOOK.md) for step-by-step provisioning of all credential sources and hardening guidance.
