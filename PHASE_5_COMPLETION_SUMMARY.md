...
- ⏳ **Vault AppRole Dry-Run Test** (Manual Dispatch)
  - Status: Dispatched (manual `workflow_dispatch` available)
...
1. Open [Emergency Credential Recovery Procedures](docs/EMERGENCY_CREDENTIAL_RECOVERY.md)
...
- [Emergency Credential Recovery Procedures](docs/EMERGENCY_CREDENTIAL_RECOVERY.md)  
