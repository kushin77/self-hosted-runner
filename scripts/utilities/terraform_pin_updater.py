#!/usr/bin/env python3
# Shim wrapper: canonical implementation for terraform pin updater lives in tools/
import os
import sys

SCRIPT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
CANONICAL = os.path.join(SCRIPT_ROOT, 'tools', 'terraform_pin_updater.py')

if not os.path.exists(CANONICAL):
    print('Canonical terraform_pin_updater not found:', CANONICAL, file=sys.stderr)
    sys.exit(2)
