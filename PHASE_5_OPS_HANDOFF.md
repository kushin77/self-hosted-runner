...
- `GCP_SERVICE_ACCOUNT_EMAIL`: From GCP setup step 3
...
- ~~`GCP_SERVICE_ACCOUNT_KEY`~~: No longer needed
...
- `GCP_SERVICE_ACCOUNT_EMAIL`: Identifies which service account to impersonate
...
- ✅ `gh secret list` shows both GCP_WORKLOAD_IDENTITY_PROVIDER and GCP_SERVICE_ACCOUNT_EMAIL
