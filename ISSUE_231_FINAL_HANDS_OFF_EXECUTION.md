...
2. **Runbook**: [docs/PHASE_2_3_OPS_RUNBOOK.md](docs/PHASE_2_3_OPS_RUNBOOK.md) — Step-by-step procedures
3. **Automation Guide**: [docs/PHASE_P3_PRE_APPLY_AUTOMATION.md](docs/PHASE_P3_PRE_APPLY_AUTOMATION.md) — Architecture overview
4. **Troubleshooting**: [PHASE_P3_RCA_E2E_TERRAFORM_FIXES.md](PHASE_P3_RCA_E2E_TERRAFORM_FIXES.md) — Common issues & fixes
