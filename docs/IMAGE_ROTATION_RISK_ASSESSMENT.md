...
- Rollback: keep previous image tags in `deploy/promoted-images.txt` and support automated rollback PRs.
...
- Promotions create PRs for review (optional auto-merge after X approvals).
