...
| **Fix trust policy** | See: [AWS_OIDC_SETUP.md](AWS_OIDC_SETUP.md) | 5 min |
...
- [GSM_AWS_CREDENTIALS_VERIFICATION.md](../archive/completion-reports/GSM_AWS_CREDENTIALS_VERIFICATION.md)
