...
|--------|--------------|-----------|--------|
| **Secrets** | [SECRETS_INDEX.md](../../runbooks/SECRETS_INDEX.md) | `audit-secrets.sh` | ✅ Live |
| **Workflows** | [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md) | `audit-workflows.sh` | ✅ Live |
| **Scripts** | [SCRIPTS_REGISTRY.md](../../runbooks/SCRIPTS_REGISTRY.md) | `audit-scripts.sh` | ✅ Live |
| **Errors** | [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md) | (Reference) | ✅ Live |
| **Configuration** | [CONFIGURATION_GUIDE.md](../../runbooks/CONFIGURATION_GUIDE.md) | (Reference) | ✅ Live |
...
- "Where's the deployment workflow?" → [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md#deployment-workflows)
- "Is this script safe to run?" → [SCRIPTS_REGISTRY.md](../../runbooks/SCRIPTS_REGISTRY.md#most-critical-scripts)
...
- [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md) — Debug common problems
