...
2. Review automation runbook: [HANDS_OFF_AUTOMATION_RUNBOOK.md](../../runbooks/HANDS_OFF_AUTOMATION_RUNBOOK.md)
...
For detailed procedures, see [HANDS_OFF_AUTOMATION_RUNBOOK.md](../../runbooks/HANDS_OFF_AUTOMATION_RUNBOOK.md)
