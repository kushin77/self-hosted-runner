...
|--------|---------|--------------|------------|--------|
| **1. Secrets** | All credentials and API keys | [SECRETS_INDEX.md](../../runbooks/SECRETS_INDEX.md) | `bash scripts/audit-secrets.sh` | ✅ Complete |
| **2. Workflows** | CI/CD and automation | [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md) | `bash scripts/audit-workflows.sh` | ✅ Complete |
| **3. Scripts** | Executable scripts | [SCRIPTS_REGISTRY.md](../../runbooks/SCRIPTS_REGISTRY.md) | `bash scripts/audit-scripts.sh` | ✅ Complete |
| **4. Errors** | Common problems & solutions | [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md) | Manual (reference) | ✅ Complete |
| **5. Configuration** | Settings and environment | [CONFIGURATION_GUIDE.md](../../runbooks/CONFIGURATION_GUIDE.md) | Manual (reference) | ✅ Complete |
...
**Start with:** [SECRETS_INDEX.md](../../runbooks/SECRETS_INDEX.md)
...
**Related files:**
- [DEVELOPER_SECRETS_GUIDE.md](../../runbooks/DEVELOPER_SECRETS_GUIDE.md) — Step-by-step guide for adding secrets
- [CONTRIBUTING.md](../../../ElevatedIQ-Mono-Repo/apps/portal/node_modules/recharts/CONTRIBUTING.md#secrets--credentials) — Secrets rules for contributors

---

### System 2: Workflows Discovery
**When:** You need to find the right workflow or understand CI/CD chains  
**Start with:** [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md)
...
**Common Questions:**
- **"How do I deploy to production?"** → See [WORKFLOWS_INDEX.md - Deployment Category](../../runbooks/WORKFLOWS_INDEX.md#deployment-workflows)
- **"What triggers this workflow?"** → See the table in [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md)
...
**Start with:** [SCRIPTS_REGISTRY.md](../../runbooks/SCRIPTS_REGISTRY.md)
...
**Common Questions:**
- **"What's the safest way to deploy?"** → See [SCRIPTS_REGISTRY.md - Most Critical Scripts](../../runbooks/SCRIPTS_REGISTRY.md#most-critical-scripts)
...
**Start with:** [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md)
...
**Common Errors:**
- **"Error: Unable to assume role"** → See [ERROR_CODES_GUIDE.md#err-aws-001](../../runbooks/ERROR_CODES_GUIDE.md)
- **"GitHub API rate limited"** → See [ERROR_CODES_GUIDE.md#err-runner-005](../../runbooks/ERROR_CODES_GUIDE.md)
- **"Terraform lock timeout"** → See [ERROR_CODES_GUIDE.md#err-tf-003](../../runbooks/ERROR_CODES_GUIDE.md)
...
**Start with:** [CONFIGURATION_GUIDE.md](../../runbooks/CONFIGURATION_GUIDE.md)
...
**Common Tasks:**
- **"How do I set up local development?"** → See [CONFIGURATION_GUIDE.md - Checklist: Environment Setup](../../runbooks/CONFIGURATION_GUIDE.md#checklist-environment-setup)
- **"What's the GitHub secret for X?"** → See [CONFIGURATION_GUIDE.md - GitHub Settings](../../runbooks/CONFIGURATION_GUIDE.md#github-settings)
- **"How do I configure Terraform?"** → See [CONFIGURATION_GUIDE.md - Terraform Variables](../../runbooks/CONFIGURATION_GUIDE.md#terraform-variables)
...
1. Create secret in GitHub → Document in [SECRETS_INDEX.md](../../runbooks/SECRETS_INDEX.md)
2. Run: `bash scripts/audit-secrets.sh --validate`
3. Update [CONTRIBUTING.md#secrets](../../../ElevatedIQ-Mono-Repo/apps/portal/node_modules/recharts/CONTRIBUTING.md#secrets--credentials) if new pattern
4. PR must reference SECRETS_INDEX update

### When Adding a Workflow
1. Create `.github/workflows/xxx.yml` → Document in [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md)
...
1. Create `scripts/xxx.sh` (with error handling!) → Document in [SCRIPTS_REGISTRY.md](../../runbooks/SCRIPTS_REGISTRY.md)
...
1. Add to [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md) with:
...
| Question | Start Here |
|----------|-----------|
| "What secrets exist?" | [SECRETS_INDEX.md](../../runbooks/SECRETS_INDEX.md) |
| "How do I add a secret?" | [DEVELOPER_SECRETS_GUIDE.md](../../runbooks/DEVELOPER_SECRETS_GUIDE.md) |
| "Which workflow does X?" | [WORKFLOWS_INDEX.md](../../runbooks/WORKFLOWS_INDEX.md) |
| "What script does Y?" | [SCRIPTS_REGISTRY.md](../../runbooks/SCRIPTS_REGISTRY.md) |
| "Error code Z?" | [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md) |
| "Config variable?" | [CONFIGURATION_GUIDE.md](../../runbooks/CONFIGURATION_GUIDE.md) |
| "I'm stuck!" | [ERROR_CODES_GUIDE.md](../../runbooks/ERROR_CODES_GUIDE.md) → Debugging Tools |
| "I'm adding something" | [CONTRIBUTING.md](../../../ElevatedIQ-Mono-Repo/apps/portal/node_modules/recharts/CONTRIBUTING.md) |
