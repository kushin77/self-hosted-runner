...
| Document | Purpose | Link |
|----------|---------|------|
| **GSM-Vault Integration** | Zero-secret architecture | [docs/GSM_VAULT_INTEGRATION.md](../../GSM_VAULT_INTEGRATION.md) |
| **Emergency Recovery** | Fallback procedures | [docs/EMERGENCY_CREDENTIAL_RECOVERY.md](../../EMERGENCY_CREDENTIAL_RECOVERY.md) |
| **Secrets Audit** | How to verify secrets | [docs/SECRETS_RUNBOOKS_AUDIT.md](../../SECRETS_RUNBOOKS_AUDIT.md) |
