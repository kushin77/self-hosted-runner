...
- **Result:**
  ...
  - ✅ Summary report: [TERRAFORM_VALIDATION_REPORT.md](../completion-reports/TERRAFORM_VALIDATION_REPORT.md)
...
|---|---|---|---|
| **Terraform Validate** | ✅ SUCCESS | [TERRAFORM_VALIDATION_REPORT.md](../completion-reports/TERRAFORM_VALIDATION_REPORT.md) | None |
