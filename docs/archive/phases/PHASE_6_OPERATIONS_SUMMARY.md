...
|----------|----------|---------|
| Operator Activation | [HANDS_OFF_OPERATOR_PLAYBOOK.md](../../runbooks/HANDS_OFF_OPERATOR_PLAYBOOK.md) | Step-by-step guide |
| Deploy Key Remediation | [DEPLOY_KEY_REMEDIATION_RUNBOOK.md](../../runbooks/DEPLOY_KEY_REMEDIATION_RUNBOOK.md) | SSH key setup |
| CI/CD Governance | [CI_CD_GOVERNANCE_GUIDE.md](../../runbooks/CI_CD_GOVERNANCE_GUIDE.md) | PR flow & rules |
