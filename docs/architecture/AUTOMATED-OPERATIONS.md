...
**Fix**:
1. Update [WORKFLOWS_INDEX.md](../runbooks/WORKFLOWS_INDEX.md)
2. Push new commit
...
- [5-SYSTEMS-INTEGRATION.md](../archive/completion-reports/5-SYSTEMS-INTEGRATION.md) — Main integration guide
- [SECRETS_INDEX.md](../runbooks/SECRETS_INDEX.md) — Secrets system
- [WORKFLOWS_INDEX.md](../runbooks/WORKFLOWS_INDEX.md) — Workflows system
- [SCRIPTS_REGISTRY.md](../runbooks/SCRIPTS_REGISTRY.md) — Scripts system
- [ERROR_CODES_GUIDE.md](../runbooks/ERROR_CODES_GUIDE.md) — Error reference
- [CONFIGURATION_GUIDE.md](../runbooks/CONFIGURATION_GUIDE.md) — Configuration reference
